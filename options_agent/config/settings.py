...
class Settings(BaseSettings):
    ...
    # ── Alpaca Market Data (free paper account) ──
    # Sign up at https://alpaca.markets for free 5-min data going back 5+ years.
    # Without keys, Alpaca still works but with IEX feed (15-min delayed).
    alpaca_api_key: str = Field(default="", description="Alpaca API key (free paper account)")
